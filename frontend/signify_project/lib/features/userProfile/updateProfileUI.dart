  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: userAsync.when(
        ...
        error: (e, _) => Center(child: Text('Error: $e', style: const TextStyle(fontFamily: 'LeagueSpartan'))),
        data: (user) {
                      ...
                      child: Padding(
                        ...
                        child: Stack(
                          ...
                          children: [
                            CircleAvatar(
                              ...
                              backgroundImage: imageFile != null
                                  ...
                                  : (profileImageUrl != null && !removePhoto
                                      ...
                                      : null),
                              child: ((user.profileImage.isEmpty && imageFile == null) || removePhoto)
                            ...
                            if ((imageFile != null || (user.profileImage.isNotEmpty && !removePhoto)))
                              Positioned(
                                top: 0,
                                right: 0,
                                child: GestureDetector(
                  ...
                  child: Form(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _StyledTextField(
                          ...
                          onTap: () async {
                            DateTime? picked = await showDatePicker(
                              context: context,
                              initialDate: DateTime.tryParse(user.dateOfBirth) ?? DateTime(2000),
                        ...
                        Row(
                          ...
                          children: [
                            _RoleOption(
                              value: 'normal user',
                              groupValue: role,
                              image: Image.asset('assets/images/radioUser.png', height: 90, width: 90),
                              onChanged: (val) => setState(() => role = val),
                            ),
                            _RoleOption(
                              value: 'hearing-impaired',
                              groupValue: role,
                              image: Image.asset('assets/images/radioUnhear.png', height: 90, width: 90),
                              onChanged: (val) => setState(() => role = val),
                            ),
                            _RoleOption(
                              value: 'speech-impaired',
                              groupValue: role,
                              image: Image.asset('assets/images/radioNospeech.png', height: 90, width: 90),
                              onChanged: (val) => setState(() => role = val),
                            ),
                          ],
                        ),
                        ...
                        if (error != null)
                          Center(child: Text(error!, style: const TextStyle(color: Colors.red, fontFamily: 'LeagueSpartan'))),
                        SizedBox(
                          width: double.infinity,
                          child: ElevatedButton(
                            onPressed: isLoading
                                ...
                                : () async {
                                    ...
                                    final data = {
                                      ...
                                      if (imageFile != null) 'profile_image': imageFile!,
      ...
      decoration: InputDecoration(
        ...
        suffixIcon: enabled
            ? IconButton(
                ...
                onPressed: controller != null ? () => controller!.clear() : null,
              )
            : null,
        hintStyle: const TextStyle(fontFamily: 'LeagueSpartan', color: Colors.black87),
        labelStyle: const TextStyle(fontFamily: 'LeagueSpartan', color: Colors.black87),
      ),
