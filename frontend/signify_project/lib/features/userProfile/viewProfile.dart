  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      body: profileAsync.when(
        ...
        error: (e, _) => Center(child: Text('Error: $e', style: const TextStyle(fontSize: 22, fontFamily: 'LeagueSpartan'))),
        data: (user) => Column(
          children: [
                  ...
                  Align(
                    ...
                    child: Padding(
                      ...
                      child: IconButton(
                        ...
                        icon: Image.asset('assets/images/logout.png', height: 40, width: 40),
                      ),
                    ),
                  ),
                  Align(
